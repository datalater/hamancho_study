...
은행은 이러한 고객의 수요에 주목했습니다. 2017년에 단행한 은행의 조직개편 내용을 보면 공통점이 있습니다. 투자신탁 또는 자산관리 부서를 전면에 내세우고, 종합금융서비스를 제공하는 복합점포를 확대하는 것입니다. 물론 이는 은행에만 국한되는 것이 아니라 금융지주사들을 중심으로 은행과 증권, 보험 등 여러 계열사의 서비스를 한 번에 처리하는 대형 복합점포가 늘어가는 추세입니다.
