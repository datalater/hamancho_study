...
>  <참고>  
>  외국의 경우 ****인터넷전문은행****은 설립 초기에 완전 무점포형태였으나 최근 ATM 확충, 키오스크, 인터넷카페 등 오프라인 채널을 확대하며 영업력을 강화하는 추세


사실 IT강국으로 유명한 우리나라에도 2001년과 2008년에 인터넷전문은행 설립 시도가 있었습니다. 하지만 그 당시만 하더라도 스마트폰의 보급율이 낮았기 때문에 대면 거래 비중이 높았고, 인터넷전문은행 설립 필요성에 대한 사회적 지지도가 낮았습니다. 또한 정부가 적극적이지 않은 태도를 보이고, 자금 유치에도 실패하면서 인터넷전문은행 설립이 무산되었습니다.
